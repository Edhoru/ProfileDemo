...
struct Fonts {
    ...
    static let t22 = UIFont(name: Fonts.OpenSans.semiBold, size: 22.0)!
    static let t16 = UIFont(name: Fonts.OpenSans.semiBold, size: 16.0)!
    
    static let b18 = UIFont(name: Fonts.OpenSans.regular, size: 18.0)!
    static let b16 = UIFont(name: Fonts.OpenSans.regular, size: 16.0)!
    static let b14 = UIFont(name: Fonts.OpenSans.regular, size: 14.0)!
    static let b13 = UIFont(name: Fonts.OpenSans.regular, size: 13.0)!
    static let b11 = UIFont(name: Fonts.OpenSans.regular, size: 11.0)!
